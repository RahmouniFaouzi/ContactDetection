...
numx = 250;numy = 250;  % element on x,y direction  % nodes on x,y direction
...
Alength=20; Blength=20;               % lenght of segments
...
for i= 0:0.5:10
ELXYM_second = [ELXYM_FIRST(:,1)-i, ELXYM_FIRST(:,2)]; % move the tool
...
xlabel('Tool Process (mm)')
ylabel('Time (S) ')
title('Runtime of  BS and all to all methods according to Tool MvM')
